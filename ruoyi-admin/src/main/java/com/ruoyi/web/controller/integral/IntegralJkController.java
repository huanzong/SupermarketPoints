...
public class IntegralJkController extends BaseController
{
	 ...
	 * 批量添加用户积分奖扣
	 */
	/*@RequiresPermissions("integral:integralJk:add")
	@Log(title = "积分奖扣", businessType = BusinessType.INSERT)
	@PostMapping("/addAll")
	@ResponseBody
	public AjaxResult addAll(IntegralJk integralJk,String[] jkNames)
	{
		return toAjax(integralJkService.insertIntegralJk(integralJk,jkNames));
